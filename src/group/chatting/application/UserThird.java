...
import java.io.*;//to recive message
 ...
 public class UserThird   implements ActionListener,Runnable {//jfram for fram and to perform action and runnable for multithreading
   ...
   JTextField text;//can be used in constructor and other function also
    ...
    UserThird(){//all fram codinng inside constructor
        f.setLayout(null);
        ...
        Image i2 = i1.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
         ImageIcon i3 = new ImageIcon(i2);//image is in i1 and ddesign is in i2 so we are creating new object i3 and putting image icone i2 in it
  ...
  }catch (Exception e)
  {
   ...
   f.invalidate();
    ...
    public static void main(String[] args){
       UserThird third=  new UserThird();// unknow object
        //creating server
