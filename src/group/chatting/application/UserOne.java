...
import java.io.*;//to recive message
 ...
 public class UserOne   implements ActionListener,Runnable {//jfram for fram and to perform action and runnable for multithreading
   ...
   JTextField text;//can be used in constructor and other function also
    ...
    UserOne(){//all fram codinng inside constructor
        f.setLayout(null);
  ...
  }catch (Exception e)
  {
   ...
   f.invalidate();
    ...
    public static void main(String[] args){
       UserOne one=  new UserOne();// unknow object
        //creating server
